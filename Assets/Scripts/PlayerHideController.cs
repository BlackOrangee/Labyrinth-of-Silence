...
public class PlayerHideController : MonoBehaviour
{
    ...
    private Assets.Scripts.PlayerMovement playerMovement;
    ...
    void Awake()
    {
        playerMovement = GetComponent<Assets.Scripts.PlayerMovement>();
    ...
    void Start()
    {
        ...
        Debug.Log("PlayerHideController: Initialized.");
    }
    ...
    public void EnterHiding(HidingSpot hidingSpot)
    {
        ...
        Debug.Log($"PlayerHideController: Player entered hiding spot '{hidingSpot.GetSpotName()}'");
    }
    ...
    public void ExitHiding()
    {
        ...
        Debug.Log("PlayerHideController: Player exited hiding");
    }
    ...
    private void ShowBlackScreen(bool show, string text = "")
    {
        if (hideCanvas != null)
        {
            ...
            Debug.Log($"PlayerHideController: Black screen {(show ? "shown" : "hidden")}. Text: '{text}'");
        }
    }
    ...
    private void CreateHideCanvas()
    {
        ...
        Debug.Log("PlayerHideController: Auto-created HideCanvas with black screen and text.");
    }
}